...
int main() {
  ...
  // For <char> in str
  // switch case:
  // // if number: put in outpur queue
  // // a function: push it in operator stack
  // // an operator:
  // // // while operator there is o2[NOT "("] at top
  // // // AND
  // // // o2 has precedance (order of operation) > o1
  // // // OR (
  // // // o2 precedance = o1 AND o1 is  TODO: left-associative
  // // // //
  try {
